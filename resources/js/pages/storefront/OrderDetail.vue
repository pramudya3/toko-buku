...
// Mode ganti bukti — salah kirim: sembunyikan preview & tampilkan form.
...
<template>
    ...
    <div class="mx-auto max-w-6xl px-4 py-8 md:px-6 md:py-12">
        <div class="flex flex-col gap-6">
            ...
            <div
                v-if="
                    hasPreorderItems && order.status === 'menunggu_konfirmasi'
                "
            ...
            >
                ...
                <p>
                    ...
                    <strong>Pre-Order</strong>. Pesanan akan diproses setelah
                    stok tersedia — Anda akan kami kabari saat stok tiba.
                </p>
            </div>
                    ...
                    <div class="grid gap-4 sm:grid-cols-2">
                        ...
                        <Card>
                            ...
                            <CardContent class="flex flex-col gap-3 text-sm">
                                ...
                                <template
                                    v-if="order.sumber_pembelian === 'toko'"
                                >
                                    <p
                                ...
                                >
                                    ...
                                    <!-- Preview bukti setelah upload (+ ganti bila salah kirim) -->
                                    <div
                                        v-if="buktiUrl && !replacing"
                                    ...
                                    >
                                        ...
                                        jika tidak, pesanan otomatis dibatalkan.
                                    </p>
                                </template>
                                ...
                                <template v-else>
                                    ...
                                    <p class="text-xs text-muted-foreground">
                                        Pesanan diproses dan dikirim sesuai
                                        alamat pengiriman.
                                    </p>
                                    <p
                                        class="flex items-center gap-2 text-muted-foreground"
