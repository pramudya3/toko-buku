...
// Footer nota: catatan + blok tanda tangan + ucapan terima kasih.
...
<template>
    <div class="mt-8">
        <p v-if="notes" class="text-xs text-slate-600">
        ...
        <p v-if="thanks" class="mt-8 text-center text-xs text-slate-500">
            {{ thanks }}
        </p>
    </div>
</template>
