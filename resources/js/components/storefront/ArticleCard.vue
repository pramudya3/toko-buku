...
<template>
    ...
    >
        <!-- Cover / Motif -->
        <div
            class="relative aspect-video overflow-hidden rounded-md bg-flat-muted"
        >
            <img
        ...
        <div class="mt-4">
            ...
            <p v-if="article.penulis" class="mt-1 text-xs text-gray-500">
